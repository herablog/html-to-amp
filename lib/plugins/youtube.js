...
function youTubeLinks() {
  ...
  this.$('a[href*="//www.youtube.com/watch"]').each(function (i, el) {
    var $el = _this.$(el);
...
function youTubeShortenLinks() {
  ...
  this.$('a[href*="//youtu.be/"]').each(function (i, el) {
    var $el = _this2.$(el);
    var href = $el.attr('href') || '';
    var id = href.split('/')[3];
    if (id) {
...
function youTubeIframe() {
  ...
  var selectors = ['iframe[src*="//www.youtube.com/embed"]', 'iframe[src*="//www.youtube-nocookie.com/embed"]'];
